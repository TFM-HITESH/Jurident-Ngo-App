...
type BlogNNewsSectionProps = {
    
};

const BlogNNewsSection:React.FC<BlogNNewsSectionProps> = () => {
    
    return <section id="about" className="py-16 bg-gray-100">
    <div className="container mx-auto">
      <h2 className="text-3xl font-semibold mb-8 text-black">Blog & News</h2>
...
export default BlogNNewsSection;